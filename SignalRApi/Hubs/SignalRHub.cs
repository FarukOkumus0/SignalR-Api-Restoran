...
namespace SignalRApi.Hubs
{
	public class SignalRHub : Hub
	{
		...
		public async Task SendProgress()
		{
			...
			var value8 = _categoryService.TActiveCategoryCount();
			await Clients.All.SendAsync("ReceiveActiveCategoryCount", value8);

			var value9 = _productService.TProductCountByCategoryNameHamburger;
			await Clients.All.SendAsync("ReceiveProductCountByCategoryNameHamburger", value9);
